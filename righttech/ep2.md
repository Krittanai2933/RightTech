...
- **Public Key** จะมี 2 รูปแบบคือ
  ...
  - **Uncompressed Public Key**
    ![Uncompressed](https://static.learnmeaBitcoin.com/diagrams/png/keys-public-key-uncompressed.png)

  - **Compressed Public Key**

    ![Compressed](https://static.learnmeabitcoin.com/diagrams/png/keys-public-key-compressed.png)

    - $\text{Prefix }02\text{ is used when }y\text{ is even}$
    - $\text{Prefix }03\text{ is used when }y\text{ is odd}$
...
- **Public keys** สามารถพบได้ใน `ScriptPubKey`, `ScriptSig`, หรือ `Witness` ของ raw transactions ขึ้นอยู่กับประเภทของ Script:
  ...
  - **P2PKH** (Pay to Public Key Hash)
    ...
    - Public Key Hash อยู่ใน **output** → `ScriptPubKey` <br><br>

  - **P2MS** (Pay to MultiSig)

    - Public Keys หลายตัวจะอยู่ใน **output** → `ScriptPubKey` <br><br>
...
- **Public Key Hash** ถูกสร้างโดยการนำ **Public Key** มา hash ด้วย:
  ...
  - ผลลัพธ์คือ Hash ขนาด **160-bit** หรือ **20 bytes** <br><br>
...
- **P2PKH (Pay to Public Key Hash)**:
  ...
  - **Public Key** จะถูกเปิดเผยใน **ScriptSig** เมื่อ **ouptput** นี้ ถูกใช้ใน **input** ใน **spending transaction**<br><br>

- **P2WPKH (Pay To Witness Public Key Hash)**:

  - **Public Key Hash** จะอยู่ใน **ScriptPubKey** ของ P2WPKH
  - **Public Key** จะถูกเปิดเผยใน **Witness** เมื่อ **ouptput** นี้ ถูกใช้ใน **input** ใน **spending transaction**<br><br>
